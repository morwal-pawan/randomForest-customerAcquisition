...
offers_file = "../test_data/offers.csv"
reduced_file = "../test_data/total_or_modified"
if testset:
	history_file = "../test_data/testHistory.csv"
else:
	history_file = "../test_data/trainHistory.csv"

# will be created
#reduced_file = "../test_data/train/test_reduced.csv" 
if testset:
	folder = "./test/"
else:
	folder = "./train/"
out_file = os.path.join(folder, "train_base_features.csv")
...
generate_features(reduced_file, out_file)
